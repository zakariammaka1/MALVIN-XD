...
cmd({
  ...
  try {
    ...
    let responseText = `*😎 MALVIN-XD LOGO MAKER 💫*\n\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n`
    + `*◈ Text:* ${q}\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n\n`
    ...
    conn.ev.on('messages.upsert', async (event) => {
      ...
      if (receivedMessage.message.extendedTextMessage.contextInfo && 
        ...
        if (logoUrls[receivedText]) {
          ...
          await conn.sendMessage(from, { image: { url: response.result.download_url }, caption: "> *© Powered By Malv8n King Tech*" }, { quoted });
        } else {
