...
const thumbnailUrl = "https://files.catbox.moe/bddvfr.jpg";
const sourceUrl = "https://whatsapp.com/channel/0029Vac8SosLY6d7CAFndv3Z";
...
cmd({
  ...
  try {
    ...
    if (!_0x501cea) {
      return _0x1967fe("*Please give Malvin XD a video title or URL*");
    }
    _0x1967fe("> © Malvin XD is Sᴇɴᴅɪɴɢ Yᴏᴜʀ ᴠɪᴅᴇᴏ Wᴀɪᴛ... ❄️");
    ...
    await _0xd6d2a7.sendMessage(_0x58af10, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "Malvin XD Video Download",
...
cmd({
  ...
  try {
    ...
    if (!_0x316468) {
      return _0xd2fbaa("*Please give Malvin XD an audio title or URL*");
    }
    _0xd2fbaa("> © Malvin is Sᴇɴᴅɪɴɢ Yᴏᴜʀ Sᴏɴɢ please Wᴀɪᴛ...❄️");
