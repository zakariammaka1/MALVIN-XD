...
cmd({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 263714757857");
    }
    const _0x5aa4f0 = require('node-fetch');
    const _0x3a87c7 = await _0x5aa4f0('https://malvinxpair-43d986d85eed.herokuapp.com/pair?phone=' + _0x4de0bb);
    ...
    await _0x50e2bb("> MALVIN PAIR COMPLETED*\n\n*Your pairing code is:* " + _0x27dff2);
